...
namespace uc
{
    namespace uwp
    {
        namespace gxu
        {
            ...
            render_world_non_linear_moment_shadow_maps_64::render_world_non_linear_moment_shadow_maps_64(initialize_context* c) : base(c)
            {
            ...
            render_world_non_linear_moment_shadow_maps_64::~render_world_non_linear_moment_shadow_maps_64()
            {

            }

            std::unique_ptr< submitable >render_world_non_linear_moment_shadow_maps_64::do_render(render_context* ctx)
            {
                //now start new ones
            ...
            std::unique_ptr< submitable >render_world_non_linear_moment_shadow_maps_64::do_render_shadows(shadow_render_context* ctx)
            {
                //now start new ones
                auto resources      = ctx->m_resources;
