...
namespace uc
{
    namespace uwp
    {
        namespace gxu
        {
            class render_world_non_linear_moment_shadow_maps_32 : public render_world_moment_shadows_data
            {
            ...
            public:
                ...
                render_world_non_linear_moment_shadow_maps_32(initialize_context* ctx);
                virtual ~render_world_non_linear_moment_shadow_maps_32();
